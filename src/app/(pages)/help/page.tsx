...
export default function HelpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-indigo-600 via-purple-600 to-pink-600 text-white font-sans p-8 sm:p-16">
      ...
      <div className="max-w-4xl mx-auto mb-12">
        <input
          ...
          className="w-full p-4 rounded-lg text-black text-lg focus:outline-none focus:ring-4 focus:ring-pink-400"
        />
      </div>
      ...
      <section className="max-w-4xl mx-auto bg-white/10 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-white/20">
        {filteredFaqs.length === 0 ? (
          <p className="text-indigo-200 text-center py-12">No results found for &quot;{searchTerm}&quot;</p>
        ) : (
          <ul>
      ...
      <footer className="max-w-4xl mx-auto mt-16 text-center text-indigo-200">
        <p>
          ...
          <a
            href="mailto:support@flashdecks.com"
